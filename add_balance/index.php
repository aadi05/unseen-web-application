            ...
            <div class="navigation-grid">
                <div class="navigation-div">
                    <ul class="navgation" style="cursor: context-menu">
                        <li><a href="../profile_home/profile3.php" style="color:white;text-decoration: none;"><i class="fas fa-long-arrow-alt-left"></i>Back</a></li>
                    </ul>
                </div>
            </div>
  ...
  <div class="col-75">
    <div class="container">
      <form method="POST">
        ...
        <input type="button" value="Continue" onclick="continue()" class="btn" style="background-color:#2f4f4f;">
      </form>
    </div>
  </div>
</div>
