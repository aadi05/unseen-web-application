  ...
  <body>
        <div class="main-grid">
            ...
            <div class="header-grid">
                ...
                <div class="location-div" style="margin-right:-30px;">
                    ...
                    <h1>Johnny English</h1>
                       <p>English|(U/A)|87mins|</p>
                        <div class="middle">
                            ...
                            <a href="seat/"><button class="text_movie">Book</button></a>
                        </div>
                    </div>
                      ...
                      <img src="img/mp2.jpg" alt="Avatar" class="image_movie movie-template" >
                       ...
                       <p>English|(U/A)|98mins|</p>
                        <div class="middle">
                            ...
                            <a href="movie/aquaman/"><button class="text_movie" name="book" value="Aquaman">Book</button></a>
                        </div>
                    </div>
                    <div class="container_movie" style="margin-left: 15%;">
                      <img src="img/mp3.jpg" alt="Avatar" class="image_movie movie-template" >
                        ...
                        <div class="middle">
                            <div><h3>Tiger</h3></div>
                            <a href="#"><button class="text_movie">Book</button></a>
                        </div>
                    </div>
                    <div class="container_movie" style="margin-left: 15%;">
