        ...
        <div class="grid-container">
            ...
            <div class="poster-grid">
                ...
                <div class="poster-div">
                    <img src="../img/mp5.jpg" style="height:100%; width:100%;">
                </div>
                <form method="POST">
            ...
            <div class="trailer-grid">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/Pb7iJnIWzNk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <div class="movie-name-grid">
                <h1>Bazaar</h1>
                <h2>Hindi/Tamil/Telgu</h2>
                <h1></h1>
            </div>
            <div class="summary-grid">
                <h1>Synopsis</h1>
                <article class="synopsis">
                     Baazaar is a 2018 film starring Saif Ali Khan, Chitrangada Singh and Radhika Apte. With a plot revolving around stock-trading, the film, according to director Gauravv K. Chawla's is about making it in the big bad world of Mumbai.
            ...
            <div class="cast-grid">
                <ul>
                   <li> 
                       <div class ="actor-1">
                            <div class="photo">
                                <img src="chitrangda.jpg">
                        </div>
                            <div class="nameroll">
                                <h4>Chitrangda<br><b>Aquaman</b></h4>
                            </div>
                        </div>
                    </li>
                     <li> 
                     ...
                     <li> 
                       <div class ="actor-3">
                            ...
                            <div class="nameroll">
                                <h4>Saif Ali Khan<br><b>Ocean Master</b></h4>
                            </div>
                        </div>
                    </li>
                     <!-- <li> 
